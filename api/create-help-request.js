...
export default async function handler(req, res) {
  ...
  try {
    ...
    const db = cachedClient.db("helpnet"); // You can rename "helpnet" to any DB name you want
    ...
    return res.status(200).json({ message: "Help request stored successfully" });
  } catch (error) {
